...
import { Box, Typography, Button, CircularProgress, IconButton, Paper, Switch, Autocomplete, TextField, FormControlLabel } from '@mui/material';
  ...
  const generateImage = async (isDownload = false) => {
    ...
    const drawSingleImage = async (pageItems, pageNum, totalPages, isDownload) => {
        ...
        pageItems.forEach((item, index) => {
            ...
            if (!img) {
                console.error(`No se pudo renderizar el item porque su imagen no cargó:`, item);
                return;
            }
